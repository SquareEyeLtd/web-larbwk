 ...
 *
 * The .law-row-grid vocabulary of parts/events/flagship-manage.php, because
 * this is the same kind of screen — LAW editing its own event rather than
 * reviewing somebody else's — and two form idioms for one job would drift.
 *
...
<h1 class="law-dashboard__title">
	<?php echo esc_html( $law_rm_new ? __( 'Add a reception', 'law' ) : sprintf( __( 'Edit %s', 'law' ), $law_rm_values['title'] ) ); ?>
</h1>
...
<div class="grid-x grid-padding-x">
	<div class="large-12 cell">
		<form class="law-event-form law-event-form--light law-booking-form law-reception-form" method="post"
