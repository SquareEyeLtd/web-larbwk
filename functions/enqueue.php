...
add_action( 'wp_enqueue_scripts', function () {
	...
	if ( law_calendar_is_calendar_page() || law_speakers_is_single() || law_account_events_is_template()
		|| is_page_template( array( 'templates/account-dashboard.php', 'templates/account-bookings-dashboard.php', 'templates/account-speakers-dashboard.php', 'templates/account-dashboard-flagship.php' ) ) ) {
		wp_enqueue_style(
			'law-calendar',
