		...
		<div class="grid-x grid-padding-x">
			<div class="large-12 cell">
				<div class="law-speakers" data-speaker-search>
					...
					<?php
					// Everyone else gets a 404 from law_speakers_archive_gate(),
					// so tell the committee why this page is still reachable
					// rather than let the preview read as live.
					if ( ! law_speakers_archive_is_public() ) :
						?>
						<p class="law-speakers__hidden" role="status"><?php esc_html_e( 'This archive is not public yet. Visitors get a "not found" page and it is kept out of the sitemap, until it is switched on in Events → Settings.', 'law' ); ?></p>
					<?php endif; ?>
